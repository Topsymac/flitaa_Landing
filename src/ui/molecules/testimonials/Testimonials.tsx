    ...
    <div className="testimonial">
      ...
      <div className="testimonial__headerDiv">
        ...
        <div className="testimonial-divOne">
          <img
            src={TestimonialImg}
            alt="flitaa testimonial"
            className="testimonialBg"
          />
          <div className="testimonial__content">
            <img
              src={quote}
              alt="flitaa quote icon"
              className="testimonial__quoteImg"
            />
            <div className="testimonial_ratings">
              <img src={stars} alt="flitaa rating stars" />
              <img src={stars} alt="litaa rating stars" />
              <img src={stars} alt="litaa rating stars" />
              <img src={stars} alt="litaa rating stars" />
              <img src={stars} alt="litaa rating stars" />
            </div>
            <p className="testimonial__paragraph">{t("testimony_one")}</p>
      ...
      <div className="testimonial_div">
        <div className="testimonial__paragraphTwo-div">
          ...
          <div className="testimonial__content">
            ...
            <p className="testimonial__paragraphTwo">{t("testimony_two")}</p>
            <div className="testimonial__userName">
              <p>Justice Ehiz</p>
            </div>
          </div>
        ...
        {/*  */}
        <div className="testimonial__paragraphTwo-div">
          <img src={TestimonialImg} alt="flitaa testimonial" className="testimonialBg" />
          <div className="testimonial__content">
            <img src={quote} alt="flitaa quote icon" className="testimonial__quoteImg" />
            <div className="testimonial_ratings">
              <img src={stars} alt="litaa rating stars" />
              <img src={stars} alt="litaa rating stars" />
              <img src={stars} alt="litaa rating stars" />
