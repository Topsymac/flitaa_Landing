        ...
        <div className="terms_wrapper">
          <div className="terms">
            ...
            <div className="terms_content">
              ...
              <br />
              <h3 className="terms-content-head">{t("flitaaPlatformRules")}</h3>
            ...
            <div className="terms_content">
              <h3 className="terms-content-head">11. {t("flitaaServices")}</h3>
            ...
            <div className="terms_content">
              <h3 className="terms-content-head">{t("thirdPartyPayments")}</h3>
            ...
            {/*  */}
            <div className="terms_content">
              <h3 className="terms-content-head">{t("flitaaInfinityLoans")}</h3>
              <br />
              {/* links */}
              <div className="terms_bulletPoint-div">
                <span className="terms_bulletPoint-span">
